# -*- coding: utf-8 -*-
"""JakcyChung_HW01_digits_recognition_mlp.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YjMQVvt4_2zryKUi7yoBF3QbhRwls-OB
...
You find this experiment in the [Demo app](https://trekhleb.dev/machine-learning-experiments/#/experiments/DigitsRecognitionMLP) and play around with it right in you browser to see how the model performs in real life.

Input layers.Hidden layers.Output layers.分別修改為256,256,20,增加了神經元，時間會變長，精度應該比較高。

kernel_regularizer=tf.keras.regularizers.l2(0.004) 調整為0.004，原為0.002

adam_optimizer = tf.keras.optimizers.Adam(learning_rate=0.002) 調整為0.002
修改了優化器的參數，應該會對學習率有影響。
"""